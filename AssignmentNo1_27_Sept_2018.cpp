...
do
{
	loop:cout<<"******************************************************\n";
	cout<<"******************************************************\n";
	cout<<"This Program Calculates the Cost of Phone Call)\n";
	cout<<"You need to provide day of the week, starting hour/min\n";
	cout<<"******************************************************\n";
	cout<<"******************************************************\n";
	cout<<endl;
	cout<<endl;
	
	cout<<"Please insert day of the week.\n";
...
cout<<"Do you want to calculate another call 'Y'/'N' :\n";
cin>>again;
